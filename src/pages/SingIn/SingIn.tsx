...
import { BtnEntrar } from '../../components/UI/Buttons/Buttons';
...
const SingIn = () => {
    return (
        <div className="flex h-screen w-full">
            ...
            <div
                className="w-1/2 flex flex-col justify-center items-center p-16 
            ...
            >
                ...
                <div>
                    <h2 className="text-4xl text-center text-(--color-neutral-200) font-light mb-6 self-start">
                        Seja bem vindo!
                    </h2>

                    <p className="text-lg text-(--color-neutral-200) self-start">
            ...
            <div className="w-1/2 bg-gray-100 flex flex-col justify-center items-center p-16">
                ...
                <h2 className="text-3xl font-semibold text-(--color-primary-300) mb-10">
                    Acesse sua conta
                </h2>
                ...
                <form action="" className="w-full max-w-xs">
                    ...
                    <div className="flex w-full items-center space-x-4 mt-4 mb-4">
                        <div className="flex-1 border-b border-(--color-primary-200)"></div>
                        <span className="flex items-center justify-center text-(--color-primary-200) text-sm font-normal leading-7 px-3">OU</span>
                        <div className="flex-1 border-b border-(--color-primary-200)"></div>
                    </div>

                    <p className="text-(--color-primary-300) text-center text-base font-medium leading-6 mb-4">Entrar com redes sociais</p>
                    <div className="flex items-center justify-center gap-x-3 mb-8">

                        <a href="javascript:;" className="relative w-9 h-9 rounded-full transition-all duration-500 flex justify-center items-center bg-(--color-primary-300) hover:bg-(--color-primary-400)">
                    ...
                    <p className="text-center text-sm text-(--color-primary-300)">
                        Não tem conta?
                        <Link to="/cadastro" className="text-(--color-primary-500) font-medium ml-1">Cadastre-se</Link>
                    </p>
